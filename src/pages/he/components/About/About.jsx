      ...
      <div className={styles.wrap}>
        <div className={styles.head}>
          <div>
            ...
            <h2 className={styles.title}>השף <em>שמגיע אליכם</em></h2>
          </div>
        ...
        <div className={styles.grid}>
          <div ref={portrait.ref} className={styles.portrait} style={portrait.style}>
            <img src="/assets/about-portrait.png" alt="השף" className={styles.portraitImg} />
          </div>
          <div className={styles.copy}>
            ...
            <p className={styles.body}>הסגנון שלי הוא החיבור בין המטבח האיטלקי לים־תיכוני, מתוך תשוקה אדירה לאירוח ולסטייל. והמטרה פשוטה - לתת לכם שקט. אתם לא צריכים לדאוג לכלום, אני כאן לייצר עבורכם בדיוק את החוויה שתמיד חלמתם עליה.</p>
            <p className={`${styles.body} ${styles.pull}`}>כשאני מגיע לאירוע שלך - אני מביא איתי את כל הדרך הזו, ונותן לכם להרגיש את הסיפור שלי על הצלחת שלכם.</p>
          </div>
        </div>
      </div>
    </section>
