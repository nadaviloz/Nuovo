...
const quotes = [
  {
    text: '”הלכתי לישון אחרי עשר ימי שההורים שלי מדברים על התה של מיכל.“',
    name: 'דנה ו.',
    meta: 'ארוחת שישי, רמת השרון'
  },
  {
    text: '”קמה מהדברים שמשתנים את המשמעות של ”שף לאירוע“. זה אחד מהם.“',
    name: 'עמית ל.',
    meta: 'אירוע עסקי, הרצליה'
  },
  {
    text: '”הזמנו את נובו לליל הולדת שלי. האורחים עדיין מדברים על המנות.“',
    name: 'מיכל א.',
    meta: 'יום הולדת לאשתו'
  }
]
  ...
  return (
    <section className={styles.host}>
      <div className={styles.wrap}>
          ...
          <div className={styles.chat}>
            <div className={styles.chatHead}>
              ...
              <div className={styles.who}>
                <div className={styles.whoName}>{review.name}</div>
        ...
        <p className={styles.note}>הודעה אמיתית · מועברת כפי שהתקבלה</p>

        <div className={styles.row}>
          {quotes.map((q, i) => (
            <div key={i} className={`${styles.tile} ${styles.quote}`}>
              <div>
                <div className={styles.qStars}>★★★★★</div>
                <p className={`${styles.qText} ${styles.qTextSm}`}>{q.text}</p>
              </div>
